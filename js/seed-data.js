  ...
  const volunteerSchedule = [
    {
      ...
      date: '2026-03-06',
      location: 'Will \Will & Renee Renee\'s',
      setupCleanup: 'James, Rachel',
      gospel: 'Will',
      kids: 'Sarah, Emily',
      it: 'John',
      songs: 'Rachel',
      passageTheme: 'Romans 5-6',
    ...
    },
    {
      ...
      setupCleanup: 'Tom, Lisa',
      gospel: 'James',
      kids: 'Rachel, Anna',
      it: 'Will',
      songs: 'Emily',
      passageTheme: 'Romans 7-8',
      createdAt: new Date().toISOString()
    },
    {
    ...
    },
    {
      ...
      date: '2026-03-27',
      location: 'Community Center',
      setupCleanup: 'James, Anna',
      gospel: 'Will',
      kids: 'Lisa, Sarah',
      it: 'Tom',
      songs: 'Rachel',
      passageTheme: 'Romans 9-10',
      createdAt: new Date().toISOString()
    }
  ];
  ...
  const orderOfService = [
    {
      id: 'oos_' + Date.now(),
      date: '2026-03-20',
      venueName: 'Will \Will & Renee Renee\'s place - Number 17',
